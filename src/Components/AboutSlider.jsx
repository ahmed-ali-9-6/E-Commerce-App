  ...
  return (
    <>
      <div className=" mb-[140px] ">
        <div className="flex mb-10" dir="ltr">
          <Swiper
            breakpoints={{
              375: {
                slidesPerView: 1,
          ...
          >
            <SwiperSlide key={1}>
              <div className=" min-w-[370px] mb-20">
                <div className="flex justify-center items-end bg-[#F5F5F5] rounded w-full pt-[38px] mb-8">
                  <img src={person2} alt="Man with shirt" loading="lazy" />
                </div>
                <div>
                  <h2 className=" text-[32px] font-medium font-inter tracking-wider">
                    Tom Cruise
                  </h2>
                  <p>{t`Founder & Chairman`}</p>
            ...
            <SwiperSlide key={2}>
              <div className=" min-w-[370px]">
                <div className="flex justify-center items-end bg-[#F5F5F5] rounded w-full pt-[38px] mb-8">
                  <img src={person1} alt="Man with Suit" loading="lazy" />
                </div>
                <div>
                  <h2 className=" text-[32px] font-medium font-inter tracking-wider">
                    Tom Hardy
                  </h2>
                  <p>{t`Managing Director`}</p>
                  <div className="flex gap-4 mt-4">
                    <a href="#">
                      <svg
                        width="24"
