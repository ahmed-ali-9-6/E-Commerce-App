...
import { ourProductsData, newProductsData } from "../../allProductsData";
...
const OurProductsList = forwardRef((props, ref) => {
  return (
        ...
        {newProductsData.map((data, index) => {
          ...
          return (
            <OurProductCard
              key={index}
              newItem={data}
              newSalePerc={data.salePerc}
              newImage={data.image}
              newProdName={data.prodName}
              newPriceAfter={data.priceAfter}
              newStars={handleStars(rate)}
              newRate={rate}
            />
          );
        })}
