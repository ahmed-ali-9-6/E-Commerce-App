...
function LogIn() {
  ...
  const HandleLoginAccountWithPassword = (e) => {
    e.preventDefault();
    ...
    >
      ...
      >
        ...
        <form
          ...
          onSubmit={HandleLoginAccountWithPassword}
        >
          <input
          ...
          <div className="flex justify-between items-center">
            <button className="py-4 w-[143px] text-[#fafafa] rounded bg-[#DB4444] hover:bg-[#db4444e0] font-medium active:scale-95">
              {t`Log In`}
            </button>
        ...
        >
          ...
          <p className=" pl-4">{t`Log in with Google`}</p>
        </button>
      </div>
    </div>
  );
