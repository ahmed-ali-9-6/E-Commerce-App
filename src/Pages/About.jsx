...
function About() {
  const [isHoveredSaller, setIsHoveredSaller] = useState(false);
  const [isHoveredMopnthly, setIsHoveredMopnthly] = useState(false);
  const [isHoveredCustomer, setIsHoveredCustomer] = useState(false);
  const [isHoveredAnualGross, setIsHoveredAnualGross] = useState(false);
  const { t } = useTranslation();

  return (
    <div className=" container mx-auto max-w-[1170px] font-poppins mt-20 mb-[140px] px-4 xl:px-0">
      <div className=" text-sm text-[#00000080] mb-[42px]">
        <span className="mr-2">{t`Home`}</span> /
        <span className="text-black ml-2"> {t`About`} </span>
      </div>
      <div className="flex flex-col lg:flex-row gap-8 sm:gap-4 justify-between items-center mb-[140px]">
        <div className="max-w-[525px]">
          <h2 className=" text-[54px] font-semibold font-inter mb-10 tracking-wider">
            {t`Our Story`}
          </h2>
          <p className=" mb-6">{t`Launced in 2015`}</p>
          <p>{t`Exclusive has more than 1 Million products to offer`}</p>
        </div>
        <div className="w-[90%] lg:w-[50%] h-[300px] sm:h-[600px] bg-[#EB7EA8]"></div>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[30px] mb-[140px]">
        <div
          className={`flex flex-col items-center border rounded py-[30px] ${
            isHoveredSaller ? "bg-[#DB4444]" : ""
          }`}
          onMouseEnter={() => setIsHoveredSaller(true)}
          onMouseLeave={() => setIsHoveredSaller(false)}
        >
          <svg
            width="81"
            height="80"
          ...
          >
            ...
            <circle
              ...
              cy="40"
              r="29"
              fill={isHoveredSaller ? "white" : "black"}
            />
            <path
              ...
              stroke={isHoveredSaller ? "black" : "white"}
              strokeWidth="2"
            />
            <path
          ...
          <span
            className={`${
              isHoveredSaller ? "text-white" : ""
            } text-[32px] font-bold font-inter mb-3 mt-6`}
          >
            10.5k
          </span>
          <p className={isHoveredSaller ? "text-white" : ""}>
            {t`Sallers active our site`}
          </p>
        </div>
        <div
          className={`flex flex-col items-center border rounded py-[30px] ${
            isHoveredMopnthly ? "bg-[#DB4444]" : ""
          }`}
          onMouseEnter={() => setIsHoveredMopnthly(true)}
          onMouseLeave={() => setIsHoveredMopnthly(false)}
        >
          <div
            className={`p-[9px] bg-black rounded-full border-[10px] ${
              isHoveredMopnthly ? "bg-white border-[#b412128e]" : ""
            }`}
          >
            <svg
              width="44"
            ...
            >
              <path
                ...
                stroke={isHoveredMopnthly ? "black" : "white"}
                strokeWidth="2.75"
                strokeLinecap="round"
          ...
          <span
            className={`${
              isHoveredMopnthly ? "text-white" : ""
            } text-[32px] font-bold font-inter mb-3 mt-6`}
          >
            33k
          </span>
          <p className={isHoveredMopnthly ? "text-white" : ""}>
            {t`Mopnthly Produduct Sale`}
          </p>
        </div>
        <div
          className={`flex flex-col items-center border rounded py-[30px] ${
            isHoveredCustomer ? "bg-[#DB4444]" : ""
          }`}
        ...
        >
          ...
          >
            ...
            <circle
              ...
              cy="40"
              r="29"
              fill={isHoveredCustomer ? "white" : "black"}
            />
            <path
              ...
              fill={isHoveredCustomer ? "black" : "white"}
            />
          </svg>
          <span
            className={`${
              isHoveredCustomer ? "text-white" : ""
            } text-[32px] font-bold font-inter mb-3 mt-6`}
          >
            45.5k
          </span>
          <p className={isHoveredCustomer ? "text-white" : ""}>
            {t`Customer active in our site`}
          </p>
        </div>
        <div
          className={`flex flex-col items-center border rounded py-[30px] ${
            isHoveredAnualGross ? "bg-[#DB4444]" : ""
          }`}
          onMouseEnter={() => setIsHoveredAnualGross(true)}
          onMouseLeave={() => setIsHoveredAnualGross(false)}
        >
          <svg
            width="81"
            height="80"
          ...
          >
            ...
            <circle
              ...
              cy="40"
              r="29"
              fill={isHoveredAnualGross ? "white" : "black"}
            />
            <path
              ...
              fill="#FAFAFA"
              stroke={isHoveredAnualGross ? "black" : "white"}
            />
            <path
          ...
          <span
            className={`${
              isHoveredAnualGross ? "text-white" : ""
            } text-[32px] font-bold font-inter mb-3 mt-6`}
          >
            25k
          </span>
          <p className={isHoveredAnualGross ? "text-white" : ""}>
